...
fmt:    .string "loop number: %d\n"                     // creat format string
        ...
        define(i_r, x19)                                // define variable i and put it in x19
        define(x_r, x20)                                // define variable x and put it in x20
...
main:
        ...
        mov     i_r, 0                                  // initialize variable i to zero
        mov     x_r, 10                                 // initialize variable x to 10
...
top:
        ...
        mov     x1, i_r                                 // put the second argument = variable i as we print the string + i variable
        bl      printf                                  // call printf function
        // increment i
        add     i_r, i_r, 1                             // i is initially 0, increment i variable 

loop_test:
        
        // loop test
        cmp     i_r, x_r                                // compare i variable with x variable
